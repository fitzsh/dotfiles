...
# Add Catppuccin theme to FZF
export FZF_DEFAULT_OPTS="--height 80% --tmux center,80% --layout reverse --border --ansi \
...
# pnpm
export PNPM_HOME="/Users/fnobles/Library/pnpm"
case ":$PATH:" in
  *":$PNPM_HOME:"*) ;;
...
# Sesh - <alt-s> to connect to session in zsh (not tmux)
