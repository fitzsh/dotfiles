...
vim.api.nvim_create_autocmd("LspAttach", {
	...
	callback = function(ev)
		...
		keymap.set("n", "gR", "<cmd>lua Snacks.lsp_references()<CR>", opts) -- show definition, references
		...
		keymap.set("n", "gt", "<cmd>lua Snacke.picker.lsp_type_definitions()<CR>", opts) -- show lsp type definitions
